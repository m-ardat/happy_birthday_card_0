...
"""
text1 = """
Тридцатник уже ближе, чем молодецкие 25, потому желаю не костенеть, пробовать новое и обрастать интересными увлечениями, дабы новые кризисы проходили мягко и почти незаметно.
"""
text2 = """
Сан Сергеич! 
